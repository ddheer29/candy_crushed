...
import { checkForMatches, clearMatches, fillRandomCandies, handleShuffleAndClear, hasPossibleMoves, shiftDown } from "./gridUtil"
...
const useGameLogic = (data: any[][], setData: (data: any) => any) => {
  ...
  const handleSwipe = async (
    ...
    if (
      ...
      Animated
        .parallel([sourceTileAnimationX, sourceTileAnimationY, targetTileAnimationX, targetTileAnimationY])
        .start(async () => {
