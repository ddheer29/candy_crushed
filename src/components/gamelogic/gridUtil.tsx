export const checkForMatches = async (grid: any[][]) => {
  ...
  // Check for horizontal matches (3 or more candies in a row)
  ...
  // Check for vertical matches (3 or more candies in a column)
...
export const handleShuffleAndClear = async (grid: any[][]) => {
  ...
  return { grid: newGrid, clearedMatchign: totalClearedCandies };
}
